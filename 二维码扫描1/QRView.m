...
- (void)initQRLine {
    qrLine  = [[UIImageView alloc] initWithFrame:CGRectMake(self.bounds.size.width / 2 - self.transparentArea.width / 2,
                                                            self.bounds.size.height / 2 - self.transparentArea.height / 2 -160,
...
- (void)show {
    ...
    [UIView animateWithDuration:kQrLineanimateDuration animations:^{
        ...
        CGFloat maxBorder = self.frame.size.height / 2 + self.transparentArea.height / 2 - 160;
        if (qrLineY > maxBorder) {
            
            qrLineY = self.frame.size.height / 2 - self.transparentArea.height /2 - 160;
        }
        qrLineY++;
    }];
}
...
- (void)drawRect:(CGRect)rect {
    ...
    CGRect clearDrawRect = CGRectMake(screenDrawRect.size.width / 2 - self.transparentArea.width / 2,
                                      screenDrawRect.size.height / 2 - self.transparentArea.height / 2 - 180,
